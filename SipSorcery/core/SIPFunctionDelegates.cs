...
namespace SIPSorcery.SIP
{
    ...
    public delegate Task SIPTransportRequestAsyncDelegate(SIPChannel localSipChannel,SIPEndPoint localSIPEndPoint, SIPEndPoint remoteEndPoint, SIPRequest sipRequest);
    public delegate Task SIPTransportResponseAsyncDelegate(SIPChannel localSipChannel,SIPEndPoint localSIPEndPoint, SIPEndPoint remoteEndPoint, SIPResponse sipResponse);
